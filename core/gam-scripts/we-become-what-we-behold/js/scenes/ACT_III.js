Game.addToManifest({
    bg_panic: "/core/gam-scripts/we-become-what-we-behold/sounds/bg_panic.mp3",
    bg_creepy: "/core/gam-scripts/we-become-what-we-behold/sounds/bg_creepy.mp3"
});
        ...
        takePhoto: function(d){
            ...
            d.tryChyron(function(d){
                ...
                if(murderer.hasGunOut){
                    ...
                    if(caught.evil){
                        d.chyron = "hats ain't cool no more, haven't you heard?";
                        return true;
                    }
                    return false;
                }
