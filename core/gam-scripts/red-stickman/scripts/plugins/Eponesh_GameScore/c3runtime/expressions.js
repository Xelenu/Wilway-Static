globalThis.C3.Plugins.Eponesh_GameScore.Exps = {
  ...
  VariablesGet: function(e) {
    return this.gp.variables.get(e)
  },
  PlatformVariablesGet(e) {
    return this.platformVariables[e] || ""
  },
  VariablesHas(e) {
  ...
  ExperimentsGet(e) {
    return this.gp.experiments.map[e] || ""
  },
  SegmentsCurSegment() {
  ...
  GenerateAvatar(e, r) {
    return this.gp.generateAvatar(e, r)
  },
  AsJSON() {
    return JSON.stringify(this.SaveToJson())
  },
  UniquesGet(e) {
    return this.gp.uniques.get(e)
  },
  UniquesCurTag() {
  ...
  IsLastConfirmSuccess() {
    return this.isLastConfirmSuccess
  }
};