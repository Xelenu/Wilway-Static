(() => {
    ...
    if (window.PokiSDK = {
        ...
        try {
            let e = localStorage.getItem("poki_events_user_id");
            e || (e = crypto.randomUUID(), "GB" !== t("country") && localStorage.setItem("poki_events_user_id", e));
            const o = t("game_id"),
                r = t("game_version_id");
            if (!o || !r) throw 1;
            const i = "1" === localStorage.getItem("poki_pbf"),
                a = e => /^[-+]?\d+$/.test(e.trim()),
                n = (e, t, o) => "game" === e && "loading" === t && "start" === o || ("game" === e && "loading" === t && "complete" === o || ("game" === e && "launch" === t && "" === o || ("game" === e && "meaningful" === t && "first" === o || ("tutorial" === e && "start" === t && "" === o || ("tutorial" === e && "complete" === t && "" === o || (!("progress" !== e || "start" !== t || !a(o)) || (!("progress" !== e || "complete" !== t || !a(o)) || (!("progress" !== e || "fail" !== t || !a(o)) || ("rewarded" === e && "visible" === t || ("rewarded" === e && "click" === t || (!("rewarded" !== e || "start" !== t || !a(o)) || (!("rewarded" !== e || "complete" !== t || !a(o)) || (!("midroll" !== e || "start" !== t || !a(o)) || (!("midroll" !== e || "complete" !== t || !a(o)) || "custom" === e))))))))))))));
            window.PokiSDK.measure = (t, a, s) => {
                "level" === (t = `${t}`) && (t = "progress"), n(t, a = void 0 === a ? "" : `${a}`, s = void 0 === s ? "" : `${s}`) ? (window.pokiMeasureBuildin = !0, window.parent.postMessage({
    ...
    const n = (() => {
            const e = window.pokiSDKVersion || t("ab") || "84a4c9242cc184d7ba10f21a56f364e28e96d993";
            let a = `poki-sdk-core-${e}.js`;
            o && (a = `poki-sdk-kids-${e}.js`), r && (a = `poki-sdk-playground-${e}.js`), i && (a = `poki-sdk-hoist-${e}.js`);
            new URL(document.currentScript.src);
            return `https://game-cdn.poki.com/scripts/${e}/${a}`
        })(),
        s = document.createElement("script");
    s.setAttribute("src", n), s.setAttribute("type", "text/javascript"), s.setAttribute("crossOrigin", "anonymous"), s.onload = () => a.dequeue(), document.head.appendChild(s)
})();
