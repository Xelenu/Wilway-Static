...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const cookieVal = getCookie('fsHideSettings');
  if (fsHideSettingsBtn) {
    fsHideSettingsEnabled = (cookieVal === 'true');
  ...
  if (animationPaused === 'true') {
    background.classList.add('paused');
    if (pauseButton) pauseButton.textContent = '🔴 Resume Animation';
  } else {
    background.classList.remove('paused');
    if (pauseButton) pauseButton.textContent = '🟢 Pause Animation';
  }
